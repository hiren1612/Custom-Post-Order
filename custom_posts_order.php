...
/*========================================================
        plugin Front end view using shortcode
========================================================*/
...
?>
            <h4> Section Name: <?php echo esc_html($name); ?> </h4>
<?php 
            $count=0;
...
<?php
            ...
            echo '<div>'.$name.' section is NOT available in this custom post order listing.</div>';
        }
...
/*========================================================
        plugin menu added as setting sub menu
========================================================*/
